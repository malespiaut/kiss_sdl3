...
static void
text_reset(kiss_textbox* textbox, kiss_vscrollbar* vscrollbar)
{
...
static void
dirent_read(kiss_textbox* textbox1, kiss_vscrollbar* vscrollbar1, kiss_textbox* textbox2, kiss_vscrollbar* vscrollbar2, kiss_label* label_sel)
{
  kiss_dirent* ent = NULL;
  kiss_stat s = {0};
  kiss_dir* dir = NULL;
  char buf[KISS_MAX_LENGTH] = {0};
  char ending[2] = {0};
  ...
  while ((ent = kiss_readdir(dir)))
  {
    ...
    if (kiss_isdir(s))
    {
      kiss_array_appendstring(textbox1->array, 0, ent->d_name, "/");
    }
    else if (kiss_isreg(s))
    {
      kiss_array_appendstring(textbox2->array, 0, ent->d_name, NULL);
    }
  }
  kiss_closedir(dir);
...
static void
textbox1_event(kiss_textbox* textbox, SDL_Event* e, kiss_vscrollbar* vscrollbar1, kiss_textbox* textbox2, kiss_vscrollbar* vscrollbar2, kiss_label* label_sel, int* draw)
{
  int index = 0;
...
static void
vscrollbar1_event(kiss_vscrollbar* vscrollbar, SDL_Event* e, kiss_textbox* textbox1, int* draw)
{
  int firstline = 0;
...
static void
textbox2_event(kiss_textbox* textbox, SDL_Event* e, kiss_vscrollbar* vscrollbar2, kiss_entry* entry, int* draw)
{
  int index = 0;
...
static void
vscrollbar2_event(kiss_vscrollbar* vscrollbar, SDL_Event* e, kiss_textbox* textbox2, int* draw)
{
  int firstline = 0;
...
static void
button_ok1_event(kiss_button* button, SDL_Event* e, kiss_window* window1, kiss_window* window2, kiss_label* label_sel, kiss_entry* entry, kiss_label* label_res, kiss_progressbar* progressbar, int* draw)
{
  char buf[KISS_MAX_LENGTH] = {0};
...
static void
button_cancel_event(kiss_button* button, SDL_Event* e, int* quit, int* draw)
{
  if (kiss_button_event(button, e, draw))
  {
    *quit = 1;
...
static void
button_ok2_event(kiss_button* button, SDL_Event* e, kiss_window* window1, kiss_window* window2, kiss_progressbar* progressbar, int* draw)
{
  if (kiss_button_event(button, e, draw))
  {
    window2->visible = 0;
...
main(int argc, char** argv)
{
  ...
  SDL_Event e = {0};
  kiss_array objects = {0};
  kiss_array a1 = {0};
  kiss_array a2 = {0};
  kiss_window window1 = {0};
  kiss_window window2 = {0};
  kiss_label label1 = {0};
  kiss_label label2 = {0};
  kiss_label label_sel = {0};
  kiss_label label_res = {0};
  kiss_button button_ok1 = {0};
  kiss_button button_ok2 = {0};
  kiss_button button_cancel = {0};
  ...
  kiss_entry_new(&entry, &window1, 1, "kiss", textbox1.rect.x, label_sel.rect.y + kiss_textfont.lineheight, 2 * textbox_width + 2 * kiss_up.w + kiss_edge);
  kiss_button_new(&button_cancel, &window1, "Cancel", entry.rect.x + entry.rect.w - kiss_edge - kiss_normal.w, entry.rect.y + entry.rect.h + kiss_normal.h);
  ...
  kiss_button_new(&button_ok2, &window2, "OK", window2.rect.x + window2.rect.w / 2 - kiss_normal.w / 2, progressbar.rect.y + progressbar.rect.h + 2 * kiss_vslider.h);
