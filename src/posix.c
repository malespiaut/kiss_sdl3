...
int
kiss_getstat(char* pathname, kiss_stat* buf)
{
#ifdef _MSC_VER
#ifdef _WIN32
...
kiss_dirent*
kiss_readdir(kiss_dir* dirp)
{
#ifdef _MSC_VER
  if (dirp->ent.d_name && (int)_findnext(dirp->fhandle, &dirp->fdata) == -1)
    return NULL;
